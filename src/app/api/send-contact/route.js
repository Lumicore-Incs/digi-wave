          ...
          <body>
            <div class="container">
              ...
              <div class="header">
                ...
                <p>Message from Digiwave Website</p>
              </div>
              ...
              <div class="content">
                ...
                <a href="mailto:${email}?subject=Re: Your Contact Message" class="cta-button">Reply to Message</a>
              </div>

              <div class="footer">
                <p class="footer-text">This message was sent from your Digiwave contact form</p>
                ...
                <p class="footer-text" style="margin-top: 10px; font-size: 12px;">
                  ...
                  <a href="tel:+94774419990" style="color: #001f3f; text-decoration: none;">+94 77 441 9990</a>
                </p>
              </div>
            </div>
          </body>
